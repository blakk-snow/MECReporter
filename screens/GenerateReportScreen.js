...
function GenerateReportScreen({ navigation }) {
  ...
  const loadLogo = async () => {
    try {
      ...
      const asset = Asset.fromModule(require('../assets/school-icon.png'));
  ...
  const generatePDFHtml = () => {
    ...
    const currentTerm = settings.academicYear + ' ' + settings.term;
    const termEndDate = formatDate(settings.schoolEndDate);
    const nextTermDate = formatDate(settings.nextTermDate);
        ...
        <body>
          <div class="header">
            ...
            <div class="school-info">
              ...
              <div class="school-address">${settings.schoolAddress1 || 'P. O. Box NB 481 - NII BOIMAN'}</div>
              <div class="school-address">${settings.schoolAddress2 || '10TH AVENUE - McCARTHY HILL - ACCRA'}</div>
              <div class="school-address">${settings.schoolPhone || '0244126150 / 0534723889 / 0540423359'}</div>
             <br/>
          ...
          <div class="student-info">
            <div class="student-info-left">
              ...
              <div class="info-row">
                <div class="info-label-right">Class:</div>
                <div>${settings.className || ''}</div>
              </div>
              <div class="info-row">
            ...
            <div class="student-info-right">
              <div class="info-row-right">
                  <div class="info-label">No. on Roll:</div>
                <div>${settings.numOnRoll || ''}</div>
              </div>
              <div class="info-row-right">
                <div class="info-label-right">Term:</div>
                <div>${settings.term || ''}</div>
              </div>
              <div class="info-row-right">
                <div class="info-label-right">Term Closes:</div>
                <div>${termEndDate}</div>
              </div>
              <div class="info-row-right">
                <div class="info-label-right">Next Term:</div>
                <div>${nextTermDate}</div>
              </div>
            </div>
          </div>
          ...
          <div class="remarks-section">
            ...
            <div><b>Interest:</b> ${studentResults.interests || ''}</div>
          </div>
          ...
          <div class="footer">
            <div>School resumes on ${nextTermDate} for the next term.</div>
          </div>
        </body>
      </html>
    `;
